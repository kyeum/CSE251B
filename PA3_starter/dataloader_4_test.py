...
class TASDataset(Dataset):
    def __init__(self, data_folder, eval_mode=False, mode=None, transform_mode = 0): # transform_mode 0 : origin, 1 : flip, 2 : rotate, 3: center_crop
...
#             print("CUR_TRANSMODE3:", self.transform_mode)
        ...
        image = np.asarray(F.to_pil_image(image), dtype="uint8")
