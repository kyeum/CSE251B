...
from dataset_factory_Morris import get_datasets
from file_utils import *
from model_factory_Morris import get_model
...
class Experiment_LSTM(object):
    def __init__(self, name):
        ...
        # Setup Experiment
        self.__sampling_type = config_data['generation']['deterministic']
    ...
    def __train(self):
        ...
        for i, (images, captions, lengths, _) in enumerate(self.__train_loader):
            ...
            y = self.__model(images, captions, lengths, self.__sampling_type, self.__temperature)
            ...
            loss = self.__criterion(y, targets.data)
    ...
    def __val(self):
        ...
        with torch.no_grad():
            ...
            if (val_loss < self.__min_val_loss):
                ...
                print("Update the best model in {} epochs".format(self.__current_epoch+1))
    ...
    def test(self):
        ...
        with torch.no_grad():
            for iter, (images, captions, lengths, img_ids) in enumerate(self.__test_loader):
                images = images.to(device)
                captions = captions.to(device)
                y = self.__model(images, captions, lengths, self.__sampling_type, self.__temperature)
                ...
                pred_text =  self.__model(images, None, lengths, self.__sampling_type, self.__temperature) # 8 x 20 x 1
